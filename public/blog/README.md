# 블로그 폴더 설명 (trip.couponmonster.co.kr)
...
주소는 `https://trip.couponmonster.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://trip.couponmonster.co.kr/blog/agoda-coupon/ |
